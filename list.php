...
<head>
  ...
  <script type='text/javascript' src='<?php echo ROOT ?>/javascripts/table.js'></script>
    ...
    <style type="text/css">
        ...
        #report th { background:#2C2C2C repeat-x scroll center left; color:#fff; padding:7px 15px; text-align:left;}
        #report td { background:#ECECEC none repeat-x scroll center left; color:#000; padding:7px 15px; }
